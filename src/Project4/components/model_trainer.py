...
class Model_Trainer:
    ...
    #! Error: params.model_name won't work
    # def finetune_best_model(self,best_model,model_name,X_train,y_train):
    #     searcher = GridSearchCV(best_model,param_grid=self.config.params.model_name) 
    ...
    def train_and_evaluate_models(self):
        ...
        joblib.dump(best_model,os.path.join(self.config.root_dir,'model.joblib'))
